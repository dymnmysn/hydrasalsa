...
class SemanticKitti(Dataset):
  ...
  def __init__(self, root,    # directory where data is
               ...
               max_points=170000,   # max number of points present in dataset
  ...
  def __getitem__(self, index):
    ...
    if self.iswaymo:
      self.sensor_img_means[-1] = 0.14
      self.sensor_img_stds[-1] = 0.125
    ...
    return proj, proj_labels
    #return proj, proj_mask, proj_labels
    #, unproj_labels, path_seq, path_name, proj_x, proj_y, proj_range, unproj_range, proj_xyz, unproj_xyz, proj_remission, unproj_remissions, unproj_n_points
