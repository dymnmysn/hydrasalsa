...
class LaserScanWaymo:
    ...
    def __init__(self, project=False, H=64, W=2650, fov_up=19, fov_down=-5, 
...
class SemLaserScanWaymo(LaserScanWaymo):
    ...
    def __init__(self, sem_color_dict=None, project=False, H=64, W=2048, fov_up=19, fov_down=-5, max_classes=24,DA=False,flip_sign=False,drop_points=False):
